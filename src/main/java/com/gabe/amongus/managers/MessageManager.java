...
public class MessageManager {
    ...
    public static String added_vent = c("&aAdded a vent to %map%");
    public static String saved_map = c("&aSaved map named %map%");
    public static String vent_mode = c("&aEntered vent mode.");
    public static String exit_vent_mode = c("&cExited vent mode.");
    ...
    public static String vent_pos1 = c("&dSet vent pos 1 to (%pos_x%, %pos_y%, %pos_z%)");
    public static String vent_pos2 = c("&dSet vent pos 2 to (%pos_x%, %pos_y%, %pos_z%)");

    public static String canceling_game = c("&cCanceling game! Not enough players. (%players%/%minplayers%)");
